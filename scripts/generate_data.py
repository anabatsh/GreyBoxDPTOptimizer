...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_test', type=int, default=2)# 1000)
    parser.add_argument('--n_val', type=int, default=2)# 1000)
    parser.add_argument('--n_train', type=int, default=10) # 2500)
    parser.add_argument('--budget', type=int, default=1000)# 5000)
    parser.add_argument('--n_runs', type=int, default=3)
    parser.add_argument('--save_data_dir', type=str, default='../data/test')
    parser.add_argument('--save_res_dir', type=str, default='../results/test')
    parser.add_argument('--problem_config', type=str, default='../configs/problem_test.yaml')
    parser.add_argument('--solver_config', type=str, default='../configs/solver.yaml')
    parser.add_argument('--max_workers', type=int, default=16)
    parser.add_argument('--if_problems_exist', type=bool, default=False)
    parser.add_argument('--if_solvers_exist', type=bool, default=False)
