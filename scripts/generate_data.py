...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_test', type=int, default=2)#100)
    parser.add_argument('--n_val', type=int, default=2)#100)
    parser.add_argument('--n_train', type=int, default=100)#2500)
    ...
    # generate data
    if os.path.exists(args.save_data_dir) and args.if_problems_exist:
    ...
    # run solvers
    if os.path.exists(args.save_res_dir) and args.if_solvers_exist:
