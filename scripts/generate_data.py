...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_data_dir', type=str, default='../data/normal_10')
    parser.add_argument('--save_res_dir', type=str, default='../results/normal_10')
    parser.add_argument('--problem_config', type=str, default='../configs/problem_normal.yaml')
    parser.add_argument('--solver_config', type=str, default='../configs/solver_dpt.yaml')
